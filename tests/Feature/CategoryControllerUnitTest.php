...
class CategoryControllerUnitTest extends TestCase
{
    ...
    public function test_show_single_category_correctly()
    {
        Category::create();
        Category::create();
        ...
        $response = $this->json('get', '/api/categories/2/2', [])
            ->assertStatus(200)
            ->assertJson([
                'category' => ['category_id' => 2, 'name' => 'drink'],
            ]);
    }

    public function test_show_single_category_correctly_with_alternative_language_record()
    {
        Category::create();
        Category::create();
